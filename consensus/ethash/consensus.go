...
var (
	FrontierBlockReward           = big.NewInt(2e+14) // Block reward in wei for successfully mining a block
	ByzantiumBlockReward          = big.NewInt(2e+14) // Block reward in wei for successfully mining a block upward from Byzantium
